...
const kBootstrapHandoffStatusEnabled = "true";

const hasBootstrapHandoffStatus = ({ env = process.env, envVars = [] } = {}) =>
  getEnvValue(env, envVars, ["ALPHACLAW_BOOTSTRAP_HANDOFF_STATUS"]) ===
  kBootstrapHandoffStatusEnabled;
...
const createGatewayTailscaleFinalizer = ({
  ...
  async ({
    ...
    return {
      ...
      tailnet,
      agentVaultOperatorUrl: result.agentVaultOperatorUrl,
      handoffViaBootstrapOrigin: hasBootstrapHandoffStatus({ env, envVars }),
    };
  };
