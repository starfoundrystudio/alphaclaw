...
const createAgentVaultService = ({
  ...
  return {
    ...
    // the only link that works for owners on managed instances (raw
    // operator URLs dead-end at a login form). Empty when unset.
    getVaultConsoleUrl: getTeamYouEntryUrl,
    listCredentials,
