...
const kHotfixes = Object.freeze([
  {
    ...
    // Without the dispatcher, Socket Mode builds its own env-proxy
    // dispatcher and connects through the same proxy.
    // Regression from openclaw/openclaw#147421 (introduced in 2026.9.4).
    ...
    replace: "/* clawbridge-hotfix:slack-socket-mode-proxy-dispatcher */",
  },
]);
