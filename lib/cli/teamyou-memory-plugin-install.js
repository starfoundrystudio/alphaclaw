...
// to the Gateway (`plugins.install` RPC); until beta.5 our Gateway ran with
// OPENCLAW_CONFIG_READONLY=1 and refused it (G3 finding #17). Clawbridge's
// startup plugin reconcile runs before the Gateway starts, so the plugin is
// installed and loaded on the Gateway's first start with no extra restart.
//
