...
const { createPluginHotfixWatcher } = require("./server/plugin-hotfix-watcher");
...
const pluginHotfixWatcher = createPluginHotfixWatcher({
  openclawDir: constants.OPENCLAW_DIR,
  getGatewayStartedAtMs: getManagedGatewayStartedAtMs,
  isGatewayLifecycleBusy,
  restartGateway,
});
