...
export const kOpenAiCodexRouteKey = "_OPENAI_CODEX_ROUTE";
export const kOpenAiCodexRouteTouchedKey = "_OPENAI_CODEX_ROUTE_TOUCHED";
export const kOpenAiCodexRoutePi = "pi";
export const kOpenAiCodexRouteRuntime = "codex";
...
export const kWelcomeGroups = [
  {
    id: "github",
    title: "GitHub",
    description: "Optional - configure GitHub backup for your config and workspace",
    fields: [
      {
  ...
  },
  {
    ...
    title: "Tailscale",
    description: "Required - connect this host to your tailnet",
    fields: [],
