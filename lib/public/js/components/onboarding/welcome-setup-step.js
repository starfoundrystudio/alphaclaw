        ...
        <p class="text-sm text-fg-muted">
          ${handoff.status === "recovering"
            ...
            : handoff.status === "complete"
              ...
              : "AlphaClaw setup is complete. Continue from the private Tailscale URL."}
        </p>
      </div>
      ${hasSetupUrl
        ? html`
            <div class="bg-field border border-border rounded-xl p-3 space-y-3">
              ...
              <ul class="list-disc pl-5 space-y-1 text-xs text-fg-dim text-left">
                ...
                <li>
                  If the dashboard does not open, confirm this device is
                  connected to your tailnet and try again.
                </li>
            ...
            <div class="grid grid-cols-2 gap-2">
              ...
              <button
                ...
                class="w-full text-sm font-medium px-4 py-3 rounded-xl transition-all ac-btn-primary ${isRedirecting
                  ? "opacity-50 cursor-not-allowed"
                  : ""}"
              >
