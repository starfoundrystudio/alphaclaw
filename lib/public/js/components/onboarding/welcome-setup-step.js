    ...
    const title = isRecovering
      ...
      : handoff.status === "complete"
        ...
        : isRedirecting
          ...
          : isTailnetHelp
            ? "Still waiting for your instance..."
    ...
    const body = isRecovering
      ...
      : handoff.status === "complete"
        ...
        : isRedirecting
          ...
          : isTailnetHelp
            ? "Clawbridge has not confirmed that your instance is ready. The server may still be starting or recovering. If the private address is unreachable, check that Tailscale is connected on this device. Checks will continue automatically."
        ...
        ? html`
            <div class="bg-field border border-border rounded-xl p-3 space-y-3">
              ...
              <ul class="list-disc pl-5 space-y-1 text-xs text-fg-dim text-left">
                ...
                <li>
                  Your dashboard opens automatically once the instance is reachable
                  and its services are ready.
                </li>
              </ul>
            </div>
          `
