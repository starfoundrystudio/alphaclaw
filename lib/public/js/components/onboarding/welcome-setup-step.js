    ...
    const body = isRecovering
      ...
      : handoff.status === "complete"
        ...
        : isRedirecting
          ...
          : isTailnetHelp
            ? "Your private URL requires a device connected to your tailnet — open Tailscale on this device and sign in. Clawbridge keeps checking and will open your dashboard automatically."
