    ...
    const body = isRecovering
      ...
      : handoff.status === "complete"
        ...
        : isRedirecting
          ...
          : isTailnetHelp
            ? "Your private URL requires a device connected to your tailnet — open Tailscale on this device and sign in. AlphaClaw keeps checking and will open your dashboard automatically."
            : "AlphaClaw setup is complete. Your instance is restarting into its final configuration; this usually takes about a minute. You will be redirected automatically.";
    return html`
      <div class="py-4 flex flex-col items-center text-center gap-3">
