          ...
          <div class="bg-field border border-border rounded-lg p-3 space-y-3">
            ...
            <div class="flex flex-wrap gap-2">
              ...
              claudeCliLoginCanSubmitCode
                ? html`
                    <${ActionButton}
                      onClick=${cancelClaudeCliAuth}
                      disabled=${claudeCliLoginSubmitting}
                      tone="neutral"
                      size="sm"
            ...
            : modelsError
              ...
              : showAllModels
                ...
                : modelAccessMode === "gateway"
                  ? "We recommend Opus, Sonnet, or GPT-5.6 through a gateway."
                : modelAccessMode === "subscription"
                  ? accountLoginNeedsSetup
                  ...
                  : "We recommend Opus, Sonnet, or GPT-5.6 for the primary agent."}
        </p>
        ${canToggleFullCatalog &&
        html`
          <button
      ...
      <div class="bg-field border border-border rounded-lg p-3 space-y-2">
        ...
        html`
          <div class="space-y-1 pt-1">
            <p class="text-xs text-fg-muted">
              ${codexAuthWaiting
                ? "Complete login in the popup. It will end on a page that fails to load — that's expected. Copy that page's full address (starts with "
                : "Paste the full redirect URL from the address bar (starts with "}
              <code class="text-xs bg-field px-1 rounded"
                >http://localhost:1455/auth/callback</code
              >) ${codexAuthWaiting
                ? " and paste it below to finish setup."
                : " to finish setup."}
            </p>
            ${!codexAuthWaiting &&
            html`
    ...
    html`
      <div class="bg-field border border-border rounded-lg p-3">
        <p class="text-xs leading-5 text-fg-dim">
          Clawbridge uses Tailscale to put this OpenClaw server on a personal
      ...
      <div class="grid gap-2 sm:grid-cols-2">
        ...
        <button
          ...
          class="inline-flex h-9 items-center justify-center rounded-xl px-3 text-sm font-medium transition-colors ac-btn-primary"
        >
          Open Tailscale Keys
        </button>
      </div>
      <div class="space-y-1">
        ...
        />
        <p class="text-xs text-fg-dim">
          The token should start with${" "}<code>tskey-api-</code>. Clawbridge
      ...
      >
        ...
        <span class="leading-5">
          ...
          account I want Clawbridge to use.
        </span>
      </label>
    `}
    ${activeGroup.id === "tailscale"
