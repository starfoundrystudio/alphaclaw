...
export const CreateChannelModal = ({
  ...
  const isGuidedBotCreate = isTelegramCreate || isDiscordCreate;
...
${slackManifest}</pre
                      ...
                      >
                        ...
                        <li>
                          Open ${" "}
                          <span class="text-body">App Home</span>
                          ${" "} in the Slack app settings and verify the AI
                          assistant view is enabled for this app.
                        </li>
                        <li>
                          Open ${" "}
                  ...
                  >
                    ...
                    <div class="mt-2 space-y-2 text-xs text-fg-muted">
                      ...
                      <ol class="list-decimal list-inside space-y-1.5">
                        <li>
                          In ${" "}
                          <span class="text-body">App Home</span>, enable the
                          AI assistant view and set the overview/suggested
                          prompts.
                        </li>
                        <li>
                        ...
                        <li>
                          ...
                          >
                          ${" "} and add the bot events:
                          <code class="font-mono text-fg-muted ml-1"
                            >${kSlackBotEvents.join(", ")}</code
                          >.
                        </li>
                        <li>
                          In ${" "}
