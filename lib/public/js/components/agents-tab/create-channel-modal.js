...
${slackManifest}</pre
                      ...
                      >
                        ...
                        <li>
                          ...
                          ${" "} in the Slack app settings and verify the agent
                          feature is enabled for this app.
                        </li>
                        <li>
                          Open ${" "}
                  ...
                  >
                    ...
                    <div class="mt-2 space-y-2 text-xs text-fg-muted">
                      ...
                      <ol class="list-decimal list-inside space-y-1.5">
                        <li>
                          In ${" "}
                          <span class="text-body">Agent</span>, enable the
                          agent feature and set the overview/suggested prompts.
                        </li>
                        <li>
