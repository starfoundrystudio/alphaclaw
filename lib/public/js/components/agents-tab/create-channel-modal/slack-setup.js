  ...
  return html`
    <div class="space-y-4">
      ...
      <div class="rounded-xl border border-border bg-field p-3 space-y-3">
        ...
        ${vaultMode
          ? html`<p class="text-xs leading-5 text-fg-muted">
              Keep both values handy — you will enter them together on the
              Agent Vault approval page, never on this instance.
            </p>`
          : null}
      </div>
      ...
      <div class="rounded-xl border border-border bg-field p-3">
        <p class="text-xs leading-5 text-fg-muted">
          AlphaClaw keeps Slack DMs in private pairing mode. In channels where
          the app is present, people and other bots can talk to it only by
          mentioning it. Bot-to-bot loop protection is enabled.
        </p>
      </div>
    </div>
  `;
    ...
    <div class="space-y-5 py-1">
      ...
      <div class="ac-surface-inset rounded-xl p-4 space-y-2">
        ...
        <ol class="list-decimal space-y-1.5 pl-5 text-xs leading-5 text-fg-muted">
          <li>Use the button below to open the app's Slack conversation.</li>
          <li>Send it any message to receive a pairing code.</li>
          <li>Return here and approve the request under Pending Pairings.</li>
          <li>
            To use a channel, invite the app. Anyone there can interact by
            mentioning it; other bots must mention it and are protected by a
            loop limit.
          </li>
        </ol>
      </div>
