  ...
  return html`
    <div class="space-y-4">
        ...
        ? html`<div class="rounded-xl border border-border bg-field p-3 space-y-2">
            ...
            <ul class="list-disc space-y-1 pl-5 text-xs leading-5 text-fg-muted">
              <li>
                ...
                for OpenClaw to read normal server messages.
              </li>
              <li>
                Enable${" "}<strong>Server Members Intent</strong> — recommended
                for role allowlists and member matching.
              </li>
            </ul>
            <p class="text-xs leading-5 text-fg-muted">
              Keep the bot token handy — you will enter it on the Agent Vault
              approval page, never on this instance.
            </p>
          </div>`
      ...
      <div class="rounded-xl border border-border bg-field p-3">
        <p class="text-xs leading-5 text-fg-muted">
          AlphaClaw keeps Discord DMs in private pairing mode. In server
          channels the bot can access, people and other bots can talk to it only
          by mentioning it. Bot-to-bot loop protection is enabled.
        </p>
      </div>
    </div>
  `;
...
export const DiscordChannelConnected = ({ bot = null, onDone = () => {} }) =>
  html`
    <div class="space-y-5 py-1">
      ...
      <div class="rounded-xl border border-border bg-field p-3">
        <p class="text-xs leading-5 text-fg-muted">
          The bot is ready in server channels it can access. Anyone there can
          interact by mentioning it, including other bots with loop protection;
          direct messages still require pairing.
        </p>
      </div>
