    ...
    <div class="space-y-4">
      <div class="ac-surface-inset rounded-xl p-4 space-y-3">
        ...
        <ol class="list-decimal space-y-1.5 pl-5 text-xs leading-5 text-fg-muted">
          ...
          <li>
            ${vaultMode
              ? "Copy the token BotFather sends — you'll enter it on the secure approval page."
              : "Copy the API token BotFather sends when the bot is created."}
          </li>
        </ol>
        <a
      ...
      <div class="rounded-xl border border-border bg-field p-3">
        <p class="text-xs leading-5 text-fg-muted">
          Direct messages require pairing. In groups, the bot only responds
          when mentioned.
        </p>
      </div>
    </div>
