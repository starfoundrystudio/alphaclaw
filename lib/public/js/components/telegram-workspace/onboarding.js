    ...
    <div class="space-y-4">
      ...
      <div class="grid grid-cols-2 gap-2">
        ...
        <button
          onclick=${onNext}
          disabled=${!botInfo}
          class="w-full text-sm font-medium px-4 py-2 rounded-xl transition-all ac-btn-primary ${!botInfo
...
export const CreateGroupStep = ({ onNext, onBack }) => html`
  <div class="space-y-4">
    ...
    <div class="grid grid-cols-2 gap-2">
      ...
      <button
        onclick=${onNext}
        class="w-full text-sm font-medium px-4 py-2 rounded-xl transition-all ac-btn-primary"
      >
        Next
      </button>
    </div>
    ...
    <div class="space-y-4">
      ...
      <div class="grid grid-cols-2 gap-2">
        ...
        <button
          ...
          class="w-full text-sm font-medium px-4 py-2 rounded-xl transition-all ac-btn-primary ${!canContinue ||
          saving
            ? "opacity-50 cursor-not-allowed"
            : ""}"
        >
