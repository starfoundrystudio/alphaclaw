...
export const Models = ({ onRestartRequired = () => {}, agentId, embedded = false }) => {
  ...
  const anthropicAuthMode = useMemo(
    () =>
  ...
  const providerHasAuth = useMemo(
    ...
    [authProfiles, codexStatus, openAiAuthMode, anthropicAuthMode, claudeCliStatus],
  );
