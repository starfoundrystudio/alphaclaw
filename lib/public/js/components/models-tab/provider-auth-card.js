                ...
                ? html`
                    <div class="ac-surface-inset rounded-lg p-3">
                      <p class="text-xs text-body">
                        Stored in Agent Vault. The key is injected at the
                        security gateway proxy and never touches this
                        instance.
                      </p>
                ...
                : vaultPendingEntry
                  ...
                  : html`
                      ...
                      >
                        <p class="text-xs text-fg-muted">
                          ${fieldValue
                            ? "This key is stored on this instance. Move it to Agent Vault; you re-enter the value on the approval page."
                            : "The key value is entered on the Agent Vault approval page — never on this instance."}
                        </p>
                        <${ActionButton}
