                  ...
                  <div style="line-height: 1.7">
                    <ol class="list-decimal list-inside space-y-2.5 ml-1">
                      ...
                      <li>
                        ...
                        )}${" "}→ click <strong>Get started</strong>: enter an
                        app name and support email, choose${" "}
                        <strong>External</strong> audience, add a contact
                        email, and create the app
                      </li>
                      <li>
                        Under${" "}${docLink(
                  ...
                  <div style="line-height: 1.7">
                    <ol class="list-decimal list-inside space-y-2.5 ml-1">
                      ...
                      <li>
                        ...
                        app name and support email, choose${" "}
                        <strong>Internal</strong> audience (Workspace only),
                        add a contact email, and create the app
                      </li>
                      <li>
                        ${" "}${docLink(
                          "https://console.cloud.google.com/apis/library",
