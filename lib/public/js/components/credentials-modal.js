              ...
              ? html`
                  <div style="line-height: 1.7">
                    <ol class="list-decimal list-inside space-y-2.5 ml-1">
                      ...
                      <li>
                        On that same form, under${" "}
                        <strong>Authorized redirect URIs</strong>, click${" "}
                      ...
                      <li>
                        ...
                        confirmation dialog into the fields below (or
                        download the JSON and upload it)
                      </li>
                      <li>
                  ...
                  <div style="line-height: 1.7">
                    <ol class="list-decimal list-inside space-y-2.5 ml-1">
                      ...
                      <li>
                        ...
                        policy and click <strong>Create</strong>
                      </li>
                      <li>
                        Open${" "}${docLink(
                          "https://console.cloud.google.com/auth/clients",
