...
export const CredentialsModal = ({
  ...
  const initialClientId = String(initialValues.clientId || "");
  const initialClientSecret = String(initialValues.clientSecret || "");
  const initialEmail = String(initialValues.email || "");
  ...
  >
      ...
      <div class="space-y-3">
        <div>
          ...
          >
            <summary class="cursor-pointer hover:text-body">
                  ...
                  <div style="line-height: 1.7">
                    <ol class="list-decimal list-inside space-y-2.5 ml-1">
                      <li>
                        ...
                        )}${" "}— any name works; click${" "}
                        <strong>Create</strong>, then make sure the new
                        project is selected in the picker at the top of the
                        console
                      </li>
                      <li>
                        Open${" "}${docLink(
                        ...
                        )}${" "}and click <strong>Get started</strong>. A
                        short wizard asks for an app name and support email;
                        choose <strong>External</strong> for Audience; add a
                        contact email; agree to the policy and click${" "}
                        <strong>Create</strong>. (Afterward you can ignore
                        the "configuration is incomplete" branding warning)
                      </li>
                      <li>
                        Open${" "}${docLink(
                          "https://console.cloud.google.com/auth/audience",
                          "Audience",
                        )}, find <strong>Test users</strong>, click${" "}
                        <strong>Add users</strong>, and${" "}
                        <strong>add your own Gmail address</strong>
                      </li>
                      <li>
                        Open${" "}${docLink(
                          "https://console.cloud.google.com/auth/clients",
                          "Clients",
                        )}${" "}and click <strong>Create client</strong>. Set
                        Application type to <strong>Web application</strong>;
                        any name works
                      </li>
                      <li>
                        On that same form, scroll to${" "}
                        <strong>Authorized redirect URIs</strong> — the second
                        section, not JavaScript origins — click${" "}
                        <strong>Add URI</strong>, paste the address below,
                        then click <strong>Create</strong>
                        ${renderRedirectUriInstruction()}
                      </li>
                      <li>
                        Before closing the confirmation dialog, copy the
                        Client ID and Client secret into the fields below (or
                        download the JSON and upload it) — Google won't show
                        the secret again
                      </li>
                      <li>
                        After saving, you'll choose which Google services to
                        allow. Use the <strong>Enable API</strong> link shown
                        next to each service to turn on its API
                      </li>
                    </ol>
                    <p class="mt-3 text-status-warning-muted/80">
                      ⚠️ New apps start in "Testing" mode: only Test Users can
                      sign in (up to 100), and sign-ins expire after 7 days. To
                      stay signed in, publish the app to Production from the
                      Audience page — no verification needed.
                    </p>
                  </div>
                `
              : html`
                  <div style="line-height: 1.7">
                    <ol class="list-decimal list-inside space-y-2.5 ml-1">
                      ...
                      <li>
                        ...
                        short wizard asks for an app name and support email;
                        choose <strong>Internal</strong> for Audience
                        (Workspace only); add a contact email; agree to the
                        policy and click <strong>Create</strong>. (Afterward
                        you can ignore the "configuration is incomplete"
                        branding warning)
                      </li>
                      <li>
                        Open${" "}${docLink(
