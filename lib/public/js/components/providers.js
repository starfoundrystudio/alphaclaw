  ...
  const renderCodexOAuth = () => html`
    <div class="border border-border rounded-lg p-3 space-y-2">
            ...
            <div class="flex gap-2">
              <button
                ...
                class=${`text-xs font-medium px-3 py-1.5 rounded-lg ${
                  codexStatus.needsReconnect ? "ac-btn-primary" : "ac-btn-secondary"
                }`}
              >
                ${codexStatus.needsReconnect
                  ? "Reconnect Codex OAuth"
                  : "Reconnect Codex"}
              </button>
              <button
      ...
      <${CodexDeviceAuthPanel}
        device=${codexDevice}
        onUseManual=${startCodexManualAuth}
      />
      ${codexAuthStarted
        ? html`
            <p class="text-xs text-fg-muted">
