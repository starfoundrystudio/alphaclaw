      ...
      ${status?.initialized
        ? html`
            <${CredentialTable}
              ...
              loading=${credentialsLoading}
              error=${credentialsError}
              consoleUrl=${credentialsPayload?.consoleUrl || ""}
              onOpenConsole=${() =>
                openExternal(credentialsPayload?.consoleUrl)}
            />
            ...
            <section class="bg-surface border border-border rounded-xl">
              ...
              >
                <div>
                  <h2 class="text-sm font-semibold text-body">Advanced</h2>
                  <p class="mt-1 text-xs text-fg-muted">
                    Brokered service rules and manual service access
                    requests. Channel and model setup handles all of this
                    automatically.
                  </p>
                </div>
              ...
              ${advancedOpen
                ? html`
                    <div class="space-y-5 border-t border-border p-5">
                      <${ServiceTable} services=${services} />
                      <div class="space-y-4">
              <div>
                <h3 class="text-xs font-semibold text-body">
