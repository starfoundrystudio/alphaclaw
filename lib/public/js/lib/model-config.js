...
export const kModelAccessModes = [
  {
    id: "subscription",
    label: "Subscription or account login",
    shortLabel: "Account login",
    description: "Use an existing account plan or CLI login.",
  },
  {
    id: "provider-api",
    label: "Provider API key",
    shortLabel: "API key",
    description: "Use an API key from the model provider directly.",
  },
  {
    id: "gateway",
    label: "AI gateway",
    shortLabel: "Gateway",
    description: "Use one gateway key to route across providers.",
  },
];
